...
public class OnFailedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_failed);
        layout = findViewById(R.id.containerOnFailed);
        ListView list = findViewById(R.id.candidaturesListOnFailed);
        list.setOnTouchListener(new OnSwipeTouchListener(OnFailedActivity.this) {
            @Override
        ...
        layout.setOnTouchListener(new OnSwipeTouchListener(OnFailedActivity.this) {
            @Override
            public void onSwipeLeft() {
                super.onSwipeLeft();
                System.out.println("SWIPE LEFT");
    ...
    private void initCandidatures(){
        ...
        CandidatureController.onFailed(token, page).enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try{
                    ...
                    ListView candidatureList  = (ListView) findViewById(R.id.candidaturesListOnFailed);
