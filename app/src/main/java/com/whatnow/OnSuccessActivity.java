...
public class OnSuccessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout = findViewById(R.id.containerOnSuccess);
        ListView list = findViewById(R.id.candidaturesListOnSuccess);
        list.setOnTouchListener(new OnSwipeTouchListener(OnSuccessActivity.this) {
            @Override
        ...
        layout.setOnTouchListener(new OnSwipeTouchListener(OnSuccessActivity.this) {
            @Override
            public void onSwipeLeft() {
                super.onSwipeLeft();
                System.out.println("SWIPE LEFT");
    ...
    private void initCandidatures(){
        ...
        CandidatureController.onSuccess(token, page).enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try{
                    ...
                    ListView candidatureList  = (ListView) findViewById(R.id.candidaturesListOnSuccess);
