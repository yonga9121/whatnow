...
public class OnSelectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_selection);
        layout = findViewById(R.id.containerOnSelection);
        ListView list = findViewById(R.id.candidaturesListOnSelection);
        list.setOnTouchListener(new OnSwipeTouchListener(OnSelectionActivity.this) {
            @Override
            ...
            public void onSwipeRight() {
                ...
                Intent intent = new Intent(getBaseContext(),OnEvaluationActivity.class);
                startActivity(intent);
                finish();
            }
        });
        layout.setOnTouchListener(new OnSwipeTouchListener(OnSelectionActivity.this) {
            @Override
            public void onSwipeLeft() {
                super.onSwipeLeft();
                System.out.println("SWIPE LEFT");
    ...
    private void initCandidatures(){
        ...
        CandidatureController.onSelection(token, page).enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try{
                    ...
                    ListView candidatureList  = (ListView) findViewById(R.id.candidaturesListOnSelection);
